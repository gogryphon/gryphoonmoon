...
This mechanism has been integrated into Bitcore-Node-Gryphonmoon which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/dashpay/insight-api-gryphonmoon#web-socket-api](https://github.com/dashpay/insight-api-gryphonmoon#web-socket-api)
* API: [https://github.com/dashpay/insight-api-gryphonmoon#instantsend-transactions](https://github.com/dashpay/insight-api-gryphonmoon#instantsend-transactions)

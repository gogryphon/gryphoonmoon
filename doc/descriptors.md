# Support for Output Descriptors in Gryphonmoon Core

Since Gryphonmoon Core v0.17, there is support for Output Descriptors. This is a
...
existing Gryphonmoon Core wallets, a convenience function `combo` is
...
All RPCs in Gryphonmoon Core will include the checksum in their output. Only

...
This document provides guidelines for internationalization of the Gryphonmoon Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `gryphonmoon_en.ts` remains unchanged.

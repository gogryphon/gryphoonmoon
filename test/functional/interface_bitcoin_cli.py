...
# The block reward of coinbaseoutput.nValue (500) GRYPHONMOON/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 500 GRYPHONMOON/block.
...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `gryphonmoon-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and gryphonmoon-cli getwalletinfo return expected wallet info")
            ...
            amounts = [BALANCE + Decimal('459.11820955'), Decimal(9), Decimal(31)]
            ...
            # Mine a block to confirm; adds a block reward (500 GRYPHONMOON) to the default wallet.

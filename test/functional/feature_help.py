...
"""Verify that starting gryphonmoond with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start gryphonmoond with -h for help text")
        ...
        self.log.info("Start gryphonmoond with -version for version information")
        ...
        self.log.info("Start gryphonmoondd with -fakearg to make sure it does not start")

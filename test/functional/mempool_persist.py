...
By default, gryphonmoond will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent gryphonmoond from writing mempool.dat to disk. Verify that `savemempool` fails")

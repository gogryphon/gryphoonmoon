...
"""Test the gryphonmoon specific ZMQ notification interfaces."""
...
class GryphonmoonZMQTest (GryphonmoonTestFramework):
    def set_test_params(self):
        ...
        self.set_gryphonmoon_test_params(5, 4, fast_dip3_enforcement=True, extra_args=extra_args)
    ...
    def run_test(self):
        self.subscribers = {}
        # Check that gryphonmoond has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all gryphonmoon related ZMQ publisher

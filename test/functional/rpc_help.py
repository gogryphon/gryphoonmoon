...
class HelpRpcTest(BitcoinTestFramework):
    ...
    def test_categories(self):
        ...
        # wrong argument count, note: Gryphonmoon's help allows for two options since we utilize subcommands
        ...
        components = ['Addressindex', 'Blockchain', 'Control', 'Gryphonmoon', 'Evo', 'Generating', 'Mining', 'Network', 'Rawtransactions', 'Util']

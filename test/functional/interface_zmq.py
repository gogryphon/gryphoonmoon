...
from test_framework.messages import gryphonmoonhash, hash256
...
def gryphonmoonhash_reversed(byte_str):
    return gryphonmoonhash(byte_str)[::-1]
...
class ZMQTest (BitcoinTestFramework):
    ...
    def _zmq_test(self):
        ...
        for x in range(num_blocks):
            ...
            assert_equal(genhashes[x], gryphonmoonhash_reversed(block[:80]).hex())

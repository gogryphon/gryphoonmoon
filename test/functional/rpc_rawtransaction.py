...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "Invalid Gryphonmoon address", self.nodes[0].createrawtransaction, [], {'foo': 0})
        ...
        # Fee 10,000 satoshis, (1 - (10000 sat * 0.00000001 BTC/sat)) = 0.11820
        outputs = { self.nodes[0].getnewaddress() : Decimal("0.118200000") }
        rawTx = self.nodes[2].createrawtransaction(inputs, outputs)

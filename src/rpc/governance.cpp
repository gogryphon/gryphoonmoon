...
static UniValue gobject_prepare(const JSONRPCRequest& request)
{
    ...
    // This command is dangerous because it consumes 5 GRYPHONMOON irreversibly.
    // If params are lost, it's very hard to bruteforce them and yet
    // users ignore all instructions on gryphonmooncentral etc. and do not save them...
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    { "gryphonmoon",               "getgovernanceinfo",      &getgovernanceinfo,      {} },
    { "gryphonmoon",               "getsuperblockbudget",    &getsuperblockbudget,    {"index"} },
    { "gryphonmoon",               "gobject",                &gobject,                {} },
    { "gryphonmoon",               "voteraw",                &voteraw,                {"tx_hash","tx_index","gov_hash","signal","outcome","time","sig"} },

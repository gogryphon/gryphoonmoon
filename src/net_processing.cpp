 ...
 *  We have 4 times smaller block times in Gryphonmoon, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        Gryphonmoon Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // GRYPHONMOON this code also handles non-TXs (Gryphonmoon specific messages)

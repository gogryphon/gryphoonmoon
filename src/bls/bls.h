...
#ifndef GRYPHONMOON_CRYPTO_BLS_H
#define GRYPHONMOON_CRYPTO_BLS_H
...
// bls-gryphonmoon uses relic, which may define DEBUG and ERROR, which leads to many warnings in some build setups
#undef ERROR
#undef DEBUG
...
#endif // GRYPHONMOON_CRYPTO_BLS_H

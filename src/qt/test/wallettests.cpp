...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_gryphonmoon-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_gryphonmoon-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_gryphonmoon-qt  # macOS
void TestGUI(interfaces::Node& node)
{
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QCOMPARE(uri.count("gryphonmoon:"), 2);

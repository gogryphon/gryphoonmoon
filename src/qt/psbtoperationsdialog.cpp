...
std::string PSBTOperationsDialog::renderTransaction(const PartiallySignedTransaction &psbtx)
{
    ...
    for (const CTxOut& out : psbtx.tx->vout) {
        ...
        tx_description.append(tr(" * Sends %1 to %2")
            .arg(BitcoinUnits::formatWithUnit(BitcoinUnits::GRYPHONMOON, out.nValue))
    ...
    if (!*analysis.fee) {
        ...
        tx_description.append(BitcoinUnits::formatWithUnit(BitcoinUnits::GRYPHONMOON, *analysis.fee));

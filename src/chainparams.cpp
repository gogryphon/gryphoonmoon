...
// Copyright (c) 2024 The Gryphonmoon Core developers
...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex("04e59fbb0524b01fe91d9cc8d5843546dccc482db8a5ec7bdbc65a2a3bf04579a8222f5ca2c6982befc4406bfcdb0ece758a2b0ca5d02d5c25c8aada925217fc94") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.DIP0024QuorumsHeight = 1;
        consensus.V19Height = 1;
        consensus.MinBIP9WarningHeight = 1; // V19 activation height + miner confirmation window
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Gryphonmoon: 1 day
        consensus.nPowTargetSpacing = 2 * 60; // Gryphonmoon: 2 minutes
        ...
        consensus.defaultAssumeValid = uint256S("0x000000bf46d6bf64d93ae57f8b170afeb8d356ffb819486c338ef59a40a4d8dc"); // Genesis block
        ...
        genesis = CreateGenesisBlock(1730825264, 13951256, 0x1e00ffff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();

        assert(consensus.hashGenesisBlock == uint256S("0x000000bf46d6bf64d93ae57f8b170afeb8d356ffb819486c338ef59a40a4d8dc"));
        assert(genesis.hashMerkleRoot == uint256S("0x18cc58b84c12f20983fbd3976c8a39ea4ab3d685eff4391eae4a62cd5f192626"));
        ...
        vSeeds.emplace_back("dnsseed.gryphonmoon.com");

        // Gryphonmoon addresses start with 'G'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,38);
        // Gryphonmoon script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,15);
        // Gryphonmoon private keys start with 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,75);
        // Gryphonmoon BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Gryphonmoon BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // Gryphonmoon BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"GgadCw1Q9Zs7WwMaGoU8xJBS8jdNxxWGKh"};
        nMinSporkKeys = 1;
        ...
        checkpointData = {
            {
                {0, uint256S("0x000000bf46d6bf64d93ae57f8b170afeb8d356ffb819486c338ef59a40a4d8dc")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Gryphonmoon: 1 day
        consensus.nPowTargetSpacing = 90; // Gryphonmoon: 90 seconds for testnet
        ...
        genesis = CreateGenesisBlock(1390666206, 512414, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000d3451baa27bcffc6d8974a061e719c746b70b9c99297c6fc28a582481de"));
        assert(genesis.hashMerkleRoot == uint256S("0x1ac4b546aefa52b0b686d1e074e90f4e8d37ecc6bf75306371c0f32ff4617f14"));
        ...
        vSeeds.emplace_back("testnet-seed.gryphonmoon.com"); // Just a static list of stable node(s), only supports x9

        // Testnet Gryphonmoon addresses start with 's'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,125);
        // Testnet Gryphonmoon script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,12);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Gryphonmoon BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Gryphonmoon BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Gryphonmoon BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"sWyoJddwU4NAMHfeLhbtpgMdZn37vpLsPB"};
        nMinSporkKeys = 1;
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        consensus.powLimit = uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 1
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Gryphonmoon: 1 day
        consensus.nPowTargetSpacing = 1.5 * 60; // Gryphonmoon: 1.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nPowDGWHeight = 60;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("gryphonmoon.com",  "devnet-seed.gryphonmoon.com"));

        // Devnet Gryphonmoon addresses start with 's'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,125);
        // Devnet Gryphonmoon script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,12);
        // Devnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Devnet Gryphonmoon BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Devnet Gryphonmoon BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Devnet Gryphonmoon BIP44 coin type is '1' (All coin's devnet default)
        nExtCoinType = 1;
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.powLimit = uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 1
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Gryphonmoon: 1 day
        consensus.nPowTargetSpacing = 1.5 * 60; // Gryphonmoon: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        ...
        // Regtest Gryphonmoon addresses start with 's'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,125);
        // Regtest Gryphonmoon script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,12);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Gryphonmoon BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Gryphonmoon BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Gryphonmoon BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;

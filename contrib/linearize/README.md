# Linearize
Construct a linear, no-fork, best version of the Gryphonmoon blockchain.
...
JSON-RPC server. Running `gryphonmoond` or `gryphonmoon-qt -server` will be sufficient.
...
* `input`: gryphonmoond blocks/ directory containing blkNNNNN.dat
